...
class ConditionAgent:
    def __init__(self, llm):
        ...
        self.prompt0 = ChatPromptTemplate.from_template("""
                  根据系统描述、当事者参与者及其描述、用户故事，生成该用户故事的前后置条件：
                  系统描述：
                  {system_desc}
                  当事者参与者：
                  {actor}
        ...
        self.prompt1 = ChatPromptTemplate.from_template("""
                  根据系统描述、参与者列表、当事者参与者及其描述、用户故事、原有条件、修改建议，重新生成条件：
                  系统描述：
                  {system_desc}
                  用户故事：
                  {user_story}
    ...
    def generate(self, system_desc: str, actor: Dict, user_story: Dict) -> Dict:
        """生成用户故事的前后置条件"""
    ...
    def regenerate(self, system_desc: str, actor: Dict, user_story: Dict,
